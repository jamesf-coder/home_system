...
# call out to icanhazip.com to get the public ip address of the server
ip=$(curl -s -X GET ipv4.icanhazip.com)
...
logger -p local7.info "Updated Cloudflare DNS to: $dnsrecord"
